...
## Format
We will present the complete OpenC2 message. Then we will discuss the bare bones actuator profile we created for this use case. Followed by a indepth look at each section with our reasoning.
