...
## Table of Contents
- [Sprint ending 27-Aug](#sprint-ending-27-aug)
   + [1. Devices](#1-devices)
...
## Sprint ending 27-Aug
TL:DR
- no :new: this sprint
- MQTT progressed but not done
- GCP progressed but not done
- SBOM definitions for these various sw's progressed
