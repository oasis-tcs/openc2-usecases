...
Initial condition is the configuration in 00.websvr_basecase.md.

Another user (User6) has previously been authenticated and authorized access to
the WS1 webserver API.
Both User6 and WS1 have a private key specifically for link 
